  ...
  return (
    <>
      <header
        ...
        `}
      >
        <div className="container mx-auto px-8 sm:px-16 md:px-24 lg:px-32 xl:px-40 2xl:px-48 py-3 sm:py-4 max-w-full">
          ...
          <nav className="flex flex-col items-center w-full h-full justify-center">
            <div className="flex flex-col items-center w-full" style={{height: '100%'}}>
              <div className="flex flex-col items-center w-full space-y-4 flex-1 justify-center">
                {navItems.map((item, index) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className={`text-2xl sm:text-3xl text-text-secondary hover:text-brand-primary transition-all duration-100 font-bold transform min-h-[44px] flex items-center justify-center w-full text-center group ${
                      isMobileMenuOpen 
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`btn-primary text-lg sm:text-xl min-h-[44px] flex items-center justify-center text-center rounded-xl transform mb-4 mt-4 max-w-xs w-full mx-auto relative overflow-hidden group ${
                  isMobileMenuOpen 
