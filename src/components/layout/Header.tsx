              ...
              <div className="flex flex-col items-center w-full space-y-4 flex-1 justify-center">
                {navItems.map((item, index) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className={`text-2xl sm:text-3xl text-text-secondary hover:text-brand-primary transition-all duration-50 font-bold transform min-h-[44px] flex items-center justify-center w-full text-center group ${
                      isMobileMenuOpen 
