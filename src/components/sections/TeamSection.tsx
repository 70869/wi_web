...
const TeamSection = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      description: 'Design enthusiast and creative force',
    ...
    },
    {
      ...
      description: 'Community moderator and server administrator',
    ...
    },
    {
      ...
      description: 'Visual artist and creative specialist',
    ...
    },
    {
      ...
      description: 'Backend architect and system engineer',
      social: { github: 'https://github.com/shie' }
    }
  ];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {teamMembers.map((member, index) => {
            // Define which members should show offline status
        ...
        <div className="animate-fade-in">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-text-secondary">Passion</div>
            </div>
          </div>
        </div>
