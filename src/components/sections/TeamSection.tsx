...
const TeamSection = () => {
  ...
  const [sectionRef, sectionInView] = useInView() as [React.RefObject<HTMLElement>, boolean];
  // Section header fade-in on scroll
  const [headerRef, headerInView] = useInView() as [React.RefObject<HTMLDivElement>, boolean];
  // Team grid fade-in on scroll
  const [gridRef, gridInView] = useInView() as [React.RefObject<HTMLDivElement>, boolean];
  // Team stats fade-in on scroll
  const [statsRef, statsInView] = useInView() as [React.RefObject<HTMLDivElement>, boolean];
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-x-3 mt-4">
                  ...
                  {member.social.volecta && (
                    <a
                      href={member.social.volecta}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 bg-surface-tertiary rounded-lg hover:bg-brand-primary hover:text-black transition-all duration-300 flex items-center justify-center"
                    >
