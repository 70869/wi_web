...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'The file hosting service is a game-changer. Fast, secure, and reliable. The team is always responsive and helpful. (wired-in) has exceeded all my expectations.',
      rating: 4
    },
    {
      name: 'GENUZX',
